...
public class WeakDemo {
	...
	private static void example1() throws InterruptedException {
		...
		//через ссылку после удаления объекта возвращается null
	...
	private static void example3() throws InterruptedException {
		...
		//пока объект не удален можно получить его из очереди на удаление.
		System.out.println("from queue " + queue.poll().hashCode());
	}
}
